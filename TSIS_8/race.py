...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("imgrace/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("imgrace/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("imgrace/coin.png")
    ...
    def move(self):
        ...
        if pygame.sprite.spritecollideany(P1, coins):
            COIN_SCORE += 1
            pygame.mixer.Sound('imgrace/coin-drop-4.mp3').play()
            self.rect.top = 0
            self.rect.center = (random.randint(100, SCREEN_WIDTH - 40), 0)
            self.speed = self.get_random_speed()
...
while restart:
    ...
    while running:
        ...
        if pygame.sprite.spritecollideany(P1, enemies):
            pygame.mixer.Sound('imgrace/crash.wav').play()
            # time.sleep(1)
            for entity in all_sprites:
                entity.kill()
            crush = True
